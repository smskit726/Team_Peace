...
<header>
  ...
  <div class="content-area">
    <div class="wrapper">
 	...
 	<div><label>아이디</label><input name="n_userid" value="${LOGIN.n_userid}"  readonly="readonly"/></div>
 	<div><label>변경할 password</label><input name="n_password" value="${LOGIN.n_password}" /></div>
 	
      <div><label>이메일</label><input name="n_email" value="${LOGIN.n_email}"/></div>
      <div><label>가입일</label><input name="n_date" value="${LOGIN.n_date}" name="p_dcode" readonly="readonly"></div>
      ...
      <div id="btn_box">
        ...
        <button type="button" id="btn-delete" onclick="location.href='${rootPath}/memberDelete/'">회원 탈퇴</button>
